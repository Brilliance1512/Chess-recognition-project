...
import keras.models
import math
model = keras.models.load_model(r'C:\Users\Dota2\Desktop\projects\chess-dataset\model3.h5')
...
mapping2 = {0:'b', 1:'n', 2:'-', 3:'p', 4:'q', 5:'r'}
mapping3 = {0:'b', 1:'k', 2:'n', 3:'-', 4:'p', 5:'q', 6:'r'}
...
def buildDataset():
    filenames = glob.glob(r'C:\Users\Dota2\Desktop\projects\chess-dataset\labeled_preprocessed\*.png')
    counter = 0
    for i in filenames:
        img = loadImage(i)
        ...
        for j in range(len(tiles)):
            pathing = r'C:\Users\Dota2\Desktop\projects\chess-dataset\figures\{}\{}.jpg'.format(fen[j], counter)
...
def debugMain():
    filenames = glob.glob(r'C:\Users\Dota2\Desktop\projects\chess\test\in\6.jpg')
    ...
    for i in range(n):
      ...
      # View
        if M is not None:
            ...
            print(produceFen(img_warp_save, mapping3, model, colormap))
...
def main(filepath):
    ...
    if M is not None:
        ...
        if not correctOrientation(img_warp_save):
            img_warp_save = rotate(img_warp_save, 90)
        colormap = getChessColor(img_warp_save)
        return produceFen(img_warp_save, mapping3, model, colormap)

    print("Failed to capture chessboard")
    return None

fen = main(r'C:\Users\Dota2\Desktop\projects\chess\test\in\6.jpg')
print(fen)